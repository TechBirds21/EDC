...
const UrinePregnancyTestPage: React.FC = () => {
  ...
  const handlePrevious = () => {
    ...
    navigate(`/employee/project/${pid}/screening/pregnancy-evaluation?${params.toString()}`);
  };
            ...
            <div className="border border-border p-4 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                <FormField
                  ...
                  value={formData.volumeApprox}
                  onChange={(value) => updateForm('volumeApprox', value)}
                  disabled={isSaved}
                />
                <FormField
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={() => updateForm('testResult', 'Positive')}
                        disabled={isSaved}
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        onChange={() => updateForm('testResult', 'Negative')}
                        disabled={isSaved}
                        className="form-radio"
                      />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={() => updateForm('eligibleYes', 'true')}
                    disabled={isSaved}
                    className="form-radio"
                  />
                  <span>Yes</span>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={() => updateForm('eligibleNo', 'true')}
                    disabled={isSaved}
                    className="form-radio"
                  />
                  <span>No</span>
...
export default UrinePregnancyTestPage;
